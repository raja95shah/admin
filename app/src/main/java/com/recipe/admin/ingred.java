 ...
 */
public class ingred extends ActionBarActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(ingred.this,recipeName,Toast.LENGTH_SHORT).show();
        ...
        edit.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                ParseObject gameScore = new ParseObject("ingredients");
                gameScore.put("recipe", recipeName);
                gameScore.put("ingredients", addtext.getText().toString().trim());
                gameScore.put("quantity", addquan.getText().toString().trim());
                gameScore.saveInBackground();
                Toast.makeText(ingred.this,addtext.getText().toString().trim()+" Added",Toast.LENGTH_SHORT).show();
                addtext.setText("");
                addquan.setText("");
            ...
            /**void getIngredients() {
             ...
             void printlist(ArrayList<String> arr,ListView view) {
                 ...
                 if (arr.isEmpty()) {
                     ...
                     Toast.makeText(ingred.this, "Empty List", Toast.LENGTH_SHORT).show();
                 } else {
